...
WITH alunos_dia01 AS (
    ...
    ON t1.idCliente = t2.idCliente AND t2.DtCriacao >= '2025-08-25' AND t2.DtCriacao < '2025-08-30'
    ...
    SELECT  *,
            ...
            -- ordeanando por qtde de interações e dia de criação (primeiro dia vai primeiro)

    FROM tb_dia_cliente
)

SELECT idCliente, dtDia, qtdeInteracoes
FROM window_funct
WHERE rn = 1